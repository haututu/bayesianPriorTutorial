...
<center>![mediationModel](walkthroughDocument_files/mediationImage.jpg)</center>
...
Which, with our current variables, we can use our same priors for our mediator equation by specifying which priors are pertaining to each response (in this case only the mediator, stress).

```{r appliedMed, eval=FALSE}
brm.mediation <- brm(
